...
<head>
    ...
    <style>
        ...
        .btn {
            background: linear-gradient(135deg, #ec4899, #f43f56);
            color: white;
            border: none;
            padding: 12px 24px;
            border-radius: 50px;
        ...
        .text-gradient {
            background:linear-gradient(135deg, #ec4899, #f43f56, #f59e0b);
        ...
        .heart-beat {
            animation: heartbeat 1.5 ease-in-out infinite;
        }
...
<body>
    ...
    <audio src="bruh.mp3" type="audio/mp3"></audio>
    <div id="app">
    ...
    <div id="content">
        <!-- step 1: Initial Reveal -->
         <div class="step active" id="step1">
            ...
            <p class="text-xl text-gray-700 mb-8"> I made something sppecial fo U ...</p>
         ...
         <!-- step 2: Birthday Message -->
          <div class="step" id="step2">
                ...
                <p class="text-lg text-gray-700 mb-6">
                    ...
                    laughter is my favorite melody, and your prese
                </p>
                <button class="btn" id="next-btn-2"> What make u special ?</button>

            </div>

        <!-- step 3: Reasons U're Amazing -->
         <div class="step" id="step3">
                ...
                <div class="reason-card">
                     ...
                     <p class="text-gray-700">The way you care about others is truly inspiring. </p>
                </div>

                <div class="reason-card">
                    <div class="emoji text-3xl">😊</div>
                    <h3 class="text-xl font-bold mb-2 text-pink-600">Your Smile</h3>
                    <p class="text-gray-700">Your passion and energy are contagious. </p>
                </div>
            ...
            <!-- Step 5: Final Wish -->
             <div class="step" id="step5">
                ...
                <p class="text-lg text-gray-700 mb-8">
                    ay your year be filled with joy, laughter, and dreams come true. May you always know how special
                    you are to me and to everyone
                </p>
                ...
                <p class="mt-8 text-gray-500">Made with ❤️ just for U </p>
            </div>
